...
class _VistaMonitorState extends State<VistaMonitor> with TickerProviderStateMixin {
                            ...
                            content: SingleChildScrollView(
                              child: Column(
                                ...
                                children: const [
                                  ...
                                  Text("https://github.com/DinDevJ/monitor_destilacion", style: TextStyle(color: Colors.blue, decoration: TextDecoration.underline)),
                                ],
                              ),
                            ),
  ...
  List<Widget> _buildGridPresiones() { final cols = SensorChartMulti.coloresFijos; return [_btnResetSelection(() => setState(() => _presionSeleccionada = -1), "Ver Todas"), const SizedBox(height: 10), GridView.count(shrinkWrap: true, physics: const NeverScrollableScrollPhysics(), crossAxisCount: 2, childAspectRatio: 2.0, mainAxisSpacing: 8, crossAxisSpacing: 8, children: [ _cardSelectable(0, "Hervidor", _getDato(10), "Psi", Colors.blue, cols[0], _presionSeleccionada, (i) => setState(() => _presionSeleccionada = i)), _cardSelectable(1, "Plato 2", _getDato(11), "Psi", Colors.blue, cols[1], _presionSeleccionada, (i) => setState(() => _presionSeleccionada = i)), _cardSelectable(2, "Plato 4", _getDato(12), "Psi", Colors.blue, cols[2], _presionSeleccionada, (i) => setState(() => _presionSeleccionada = i)), _cardSelectable(3, "Plato 6", _getDato(13), "Psi", Colors.blue, cols[3], _presionSeleccionada, (i) => setState(() => _presionSeleccionada = i)), _cardSelectable(4, "Plato 8", _getDato(14), "Psi", Colors.blue, cols[4], _presionSeleccionada, (i) => setState(() => _presionSeleccionada = i)), _cardSelectable(5, "Plato 10", _getDato(15), "Psi", Colors.blue, cols[5], _presionSeleccionada, (i) => setState(() => _presionSeleccionada = i)), _cardSelectable(6, "Condensador", _getDato(16), "Psi", Colors.blue, cols[6], _presionSeleccionada, (i) => setState(() => _presionSeleccionada = i)), ])]; }
